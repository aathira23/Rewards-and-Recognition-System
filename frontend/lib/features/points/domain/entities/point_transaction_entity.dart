...
class PointTransactionEntity extends Equatable {
  ...
  // Extra detail fields (populated by the enriched backend response)
  final String? createdAtFull; // ISO timestamp with time
  final String? direction; // "Credit" | "Debit"
  final String? referenceType; // "ECARD", "AWARD", "REDEMPTION", etc.
